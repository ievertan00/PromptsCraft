      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <button 
            ...
            className="px-5 py-2.5 rounded-lg bg-theme-primary bg-opacity-80 hover:bg-theme-primary-light text-white font-medium transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button 
            ...
            className="px-5 py-2.5 rounded-lg bg-red-600 bg-opacity-80 hover:bg-red-700 text-white font-medium transition-colors flex items-center justify-center gap-2"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
